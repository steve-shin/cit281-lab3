...
const {reverseString} = require('./lab-03-module.js');
const {concatenateString} = require('./lab-03-module.js');
...
for (const value of Object.keys(car)) {
    if (value == 'owners') {
        console.log(car.owners[0].first, car.owners[0].last)
        console.log(car.owners[1].first, car.owners[1].last)
    }
    else {
...
console.log(concatenateString("cba"))
